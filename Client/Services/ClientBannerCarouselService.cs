...
namespace GIBS.Module.BannerCarousel.Services
{
    ...
    public class ClientBannerCarouselService : ServiceBase, IBannerCarouselService
    {
        public ClientBannerCarouselService(HttpClient http, SiteState siteState) : base(http, siteState) { }
        ...
        public async Task<List<Models.BannerCarousel>> GetBannerCarouselsAsync(int ModuleId)
        {
            ...
            return BannerCarousels.OrderBy(item => item.Title).ToList();
        }
